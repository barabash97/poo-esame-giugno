...
/**
 * Modella uan formica <EM>inseguitrice</EM>. <B>(VEDI DOMANDA 2)</B>
 */
public class Inseguitrice extends Formica {
	...
	public Inseguitrice(Ambiente ambiente) {
		super(ambiente, Inseguitrice.progId);
		Inseguitrice.progId++;
	}
	...
	public Direzione cambioDirezione(Set<Direzione> possibili) {
		 ...
		 */
		final Direzione direzioneFerormone = this.getAmbiente().getDirezioneFerormoneVicino(this.getPosizione());
